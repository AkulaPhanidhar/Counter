...
function Next1() {
    let hol = document.getElementById("bob")
    // hol.innerText = parseInt(hol.innerText) + 1
    N = N + 1
    hol.innerText = N
}
...
function Next2() {
    let boy = document.getElementById("bob")
    boy.style.color = "black"
    if (boy.innerText == "0") {
...
let full1 = () => {
    let bot = document.getElementById("bob")
    bot.style.color = "red"
}
